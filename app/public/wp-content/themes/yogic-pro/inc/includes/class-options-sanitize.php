...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'yogic-pro' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'yogic-pro' ),
		'repeat-y'  => __( 'Repeat Vertically', 'yogic-pro' ),
		'repeat'    => __( 'Repeat All', 'yogic-pro' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'yogic-pro' ),
		'top center'    => __( 'Top Center', 'yogic-pro' ),
		'top right'     => __( 'Top Right', 'yogic-pro' ),
		'center left'   => __( 'Middle Left', 'yogic-pro' ),
		'center center' => __( 'Middle Center', 'yogic-pro' ),
		'center right'  => __( 'Middle Right', 'yogic-pro' ),
		'bottom left'   => __( 'Bottom Left', 'yogic-pro' ),
		'bottom center' => __( 'Bottom Center', 'yogic-pro' ),
		'bottom right'  => __( 'Bottom Right', 'yogic-pro')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'yogic-pro' ),
		'fixed'  => __( 'Fixed in Place', 'yogic-pro')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'yogic-pro' ),
		'italic'      => __( 'Italic', 'yogic-pro' ),
		'bold'        => __( 'Bold', 'yogic-pro' ),
		'bold italic' => __( 'Bold Italic', 'yogic-pro' )
		);
