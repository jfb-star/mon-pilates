    ...
    <div class="middle-align">
        <div class="site-main sitefull bloggridlayout">
            ...
            <?php if( $query->have_posts() ) : ?>
                    ...
                    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                        ...
                        <?php if ( is_search() || !is_single() ) : // Only display Excerpts for Search ?>
                            <div class="entry-summary">                                
                                <p><?php echo wp_trim_words( get_the_content(), of_get_option('blogpostexcerptlength'), '' ); ?></p>
                        ...
                        <?php else : ?>
                            <div class="entry-content">
                                <?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'classy-pro' ) ); ?>
                                <?php
                                    wp_link_pages( array(
                                        'before' => '<div class="page-links">' . __( 'Pages:', 'classy-pro' ),
                                        'after'  => '</div>',
                                    ) );
                                ?>
                            </div><!-- .entry-content -->
                ...
                <?php endwhile; ?>
                <?php yogic_pro_custom_blogpost_pagination( $query ); ?>
