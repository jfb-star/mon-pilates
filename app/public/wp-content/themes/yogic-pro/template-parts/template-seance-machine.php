...
<div class="mp-machine-page mp-seances-page">
    ...
    <section class="mp-hero mp-hero-machine">
        <div class="mp-hero-inner">
            ...
            <p class="mp-hero-badge">3 personnes maximum par séance</p>
    ...
    <div class="mp-content-container">
            ...
            <div class="mp-section-inner">
                ...
                <div class="mp-values-grid">
                    ...
                    <div class="mp-value-card">
                        ...
                        <p>Travailler sur Reformer demande une attention particulière à l'alignement. En limitant à 3 personnes — un format encore plus restreint que le tapis, une personne par Reformer — je peux passer auprès de chacun, ajuster les réglages et corriger en temps réel.</p>
                    </div>
        ...
        <section class="mp-cta-section">
            <div class="mp-cta-inner">
                ...
                <p class="mp-cta-reassurance">3 personnes maximum, débutants bienvenus<br>Studio à Larmor-Plage, à 10 min de <a href="<?php echo esc_url(home_url('/pilates-lorient/')); ?>">Lorient</a>, 5 min de <a href="<?php echo esc_url(home_url('/pilates-ploemeur/')); ?>">Ploemeur</a></p>
...
<script type="application/ld+json">
{
    ...
    "description": "Cours collectif sur Reformer en petit groupe (3 personnes maximum) à Larmor-Plage. Le travail ciblé des appareils Pilates avec la dynamique du collectif, à un tarif accessible.",
    "provider": {
        "@type": "LocalBusiness",
        "name": "Mon Pilates",
        "address": {
