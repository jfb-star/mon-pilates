...
const moods: MoodOption[] = [
  {
    ...
    courses: [
      { slug: "doux", name: "Pilates Doux", description: "\u00c9tirements et relaxation profonde" },
      { slug: "mat", name: "Pilates Mat", description: "Renforcement postural apaisant" },
    ],
  ...
  },
  {
    ...
    courses: [
      { slug: "doux", name: "Pilates Doux", description: "Mouvements lents et r\u00e9g\u00e9n\u00e9rants" },
      { slug: "pilates-senior", name: "Pilates Senior", description: "Mobilit\u00e9 douce et progressive" },
    ],
  ...
  },
  {
    ...
    courses: [
      { slug: "intensif", name: "Pilates Intensif", description: "Cardio et renforcement intense" },
      { slug: "reformer", name: "Pilates Reformer", description: "Travail en profondeur sur machine" },
    ],
  ...
  },
  {
    ...
    courses: [
      { slug: "doux", name: "Pilates Doux", description: "\u00c9tirements cibl\u00e9s et mobilit\u00e9" },
      { slug: "mat", name: "Pilates Mat", description: "Travail postural tout en douceur" },
    ],
  ...
  },
  {
    ...
    colorText: "text-mp-sage",
    courses: [
      { slug: "reformer", name: "Pilates Reformer", description: "Sculptez votre silhouette" },
      { slug: "intensif", name: "Pilates Intensif", description: "Repoussez vos limites" },
    ],
