...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Contactez le studio Mon Pilates a Larmor-Plage. Formulaire de contact, telephone, email et plan d'acces.",
  openGraph: {
    title: "Contact | Mon Pilates",
    description:
      "Une question ? Contactez-nous par formulaire, telephone ou email. Studio de Pilates a Larmor-Plage.",
  },
};
      ...
      <section className="relative bg-gradient-to-br from-mp-sand via-mp-cream to-mp-ocean-light/20 pt-32 pb-16 sm:pb-20">
        <div className="mp-container text-center">
          ...
          <p className="font-body text-lg sm:text-xl text-mp-text-light leading-relaxed max-w-2xl mx-auto">
            Une question, une reservation ou simplement envie d&apos;en savoir
            plus ? Nous sommes a votre ecoute.
          </p>
        </div>
      </section>
      ...
      <section className="mp-section bg-mp-cream">
        <div className="mp-container text-center">
          ...
          <p className="font-body text-mp-text-light mb-8 max-w-md mx-auto">
            Retrouvez-nous sur les reseaux sociaux pour decouvrir les coulisses
            du studio, des conseils et l&apos;actualite de Mon Pilates.
          </p>
